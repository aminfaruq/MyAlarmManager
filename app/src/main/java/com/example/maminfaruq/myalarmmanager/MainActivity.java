package com.example.maminfaruq.myalarmmanager;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_set_repeating_alarm:
                ...
                String repeateMessage = edtRepeatingMessage.getText().toString();
                alarmReceiver.setRepeatingAlarm(this,AlarmReceiver.TYPE_REPEATING,
                        repeatTime,repeateMessage);
                break;
